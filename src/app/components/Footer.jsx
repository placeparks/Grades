...
<p className='text-white poppins-medium text-center text-md md:text-xl'>Join our mailing list to stay in the loop with our newest feature releases, NFT drops, and tips and Tricks</p>
      <form className="mt-6">
